...
struct bitmap *bitmap_create (size_t bit_cnt); // check
...
void bitmap_set (struct bitmap *, size_t idx, bool); // chcek
void bitmap_mark (struct bitmap *, size_t idx);
void bitmap_reset (struct bitmap *, size_t idx); // check
...
size_t bitmap_scan_and_flip (struct bitmap *, size_t start, size_t cnt, bool); // chcek
